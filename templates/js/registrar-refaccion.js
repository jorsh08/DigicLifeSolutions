...
habilitar(nombre, baarcode, costo, precio, proveedor, descripcion, imagen);
...
function habilitar(nombre, baarcode, costo, precio, proveedor, descripcion, imagen){
    if (nombre && baarcode&& costo&& precio && proveedor && descripcion && imagen){
