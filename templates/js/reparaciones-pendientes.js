...
async function leerJSON() {
    var respuestaReparaciones = await fetch("/json-pendientes");
                    ...
                    <div class="contenido-reparaciones">
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="row mt-1">
                                    <div class="col">
                                        <a href="/finalizar_rep?id_rep=${js[x].id_rep}" style="color: var(--verde);"><i class="fa-solid fa-circle-check"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
